...
// 方案表单态与 config 的映射已提为共享模块（首页快捷操作的同名弹框共用同一口径）。
import {
  CF_MODE_HELP,
  EMPTY_FORM,
  configFromForm,
...
} from "@/components/console/quick-actions/tunnel-form"
...
import type { TunnelBinding, TunnelKind, TunnelScheme } from "@/api/tunnelClient"
